...
=======|__/=========================
  API References of myTestorProxy
           ----- oOo -----
[procedure] api_testor_cell_not_greater_than
====================================
...
procedure mytestorproxy.api_testor_cell_not_greater_than ( 
...
execute stmt_testor_test_cells;
deallocate prepare stmt_testor_test_cells;
call mytestorproxy.api_testor_cell_not_greater_than( @v_token, @v_test_id, @v_suite_id, @v_case_id, 'num.not_greater_than.1', @v_table, @v_field, @v_where, @v_order, @v_limit, @v_num_b ); select @v_test_id as `test_id`, @v_suite_id as `suite_id`, @v_case_id as `case_id`;
...
| case        | test                   | message                                                                                          |
+-------------+------------------------+--------------------------------------------------------------------------------------------------+
| table-users | num.not_greater_than.1 | [num.not_greater_than.1] test (cell_not_greater_than) is success. \nOperand: 25.5\nValue: 30.5\n |
+-------------+------------------------+--------------------------------------------------------------------------------------------------+
