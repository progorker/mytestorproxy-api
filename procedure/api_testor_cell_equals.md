...
=======|__/=========================
  API References of myTestorProxy
           ----- oOo -----
 [procedure] api_testor_cell_equals
====================================
...
procedure mytestorproxy.api_testor_cell_equals ( 
...
execute stmt_testor_test_cells;
deallocate prepare stmt_testor_test_cells;
call mytestorproxy.api_testor_cell_equals( @v_token, @v_test_id, @v_suite_id, @v_case_id, 'num.equals.1', @v_table, @v_field, @v_where, @v_order, @v_limit, @v_num_b ); select @v_test_id as `test_id`, @v_suite_id as `suite_id`, @v_case_id as `case_id`;
...
| case        | test         | message                                                                      |
+-------------+--------------+------------------------------------------------------------------------------+
| table-users | num.equals.1 | [num.equals.1] test (cell_equals) is success. \nOperand: 20.5\nValue: 20.5\n |
+-------------+--------------+------------------------------------------------------------------------------+
